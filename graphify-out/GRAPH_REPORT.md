...
## Corpus Check
- 83 files · ~87,593 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1587 nodes · 3526 edges · 48 communities detected
- Extraction: 52% EXTRACTED · 48% INFERRED · 0% AMBIGUOUS · INFERRED: 1700 edges (avg confidence: 0.5)
...
Cohesion: 0.04
Nodes (111): AgentInfo, create_project(), _extract_memories(), get_agent(), get_config(), get_messages(), get_project(), list_agents() (+103 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (61): LLMConfigModel, JSON Schema for a tool, ToolSchema, BaseModel, CollaborationManager, CollaborationStrategy, MultiAgentStrategy, Multiple agents collaborate on complex tasks (+53 more)
...
Cohesion: 0.03
Nodes (29): AssetService, BootstrapStageExecutor, Owns the scaffold generation path until a real runtime replaces it., Asset, AssetLink, Decision, DecisionAsset, StageRun (+21 more)
...
- **Why does `Project` connect `Community 3` to `Community 0`, `Community 1`, `Community 2`, `Community 5`, `Community 9`, `Community 12`?**
  _High betweenness centrality (0.108) - this node is a cross-community bridge._
- **Why does `BaseTool` connect `Community 0` to `Community 1`?**
  _High betweenness centrality (0.099) - this node is a cross-community bridge._
- **Why does `LLMClient` connect `Community 3` to `Community 16`, `Community 9`, `Community 2`, `Community 15`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Are the 120 inferred relationships involving `Project` (e.g. with `TestPipelineCreation` and `TestPipelineStart`) actually correct?**
  _`Project` has 120 INFERRED edges - model-reasoned connections that need verification._
