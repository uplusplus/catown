...
## Corpus Check
- 79 files · ~86,207 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1545 nodes · 3284 edges · 50 communities detected
- Extraction: 55% EXTRACTED · 45% INFERRED · 0% AMBIGUOUS · INFERRED: 1479 edges (avg confidence: 0.5)
...
Cohesion: 0.04
Nodes (127): AgentInfo, create_project(), _extract_memories(), get_agent(), get_config(), get_messages(), get_project(), list_agents() (+119 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (55): LLMConfigModel, BaseModel, CollaborationStrategy, MultiAgentStrategy, Multiple agents collaborate on complex tasks, Base class for collaboration strategies, Select which agents should respond, Default: Single agent responds based on @ mention or default (+47 more)

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (84): audit_timeline(), Event, get_llm_call(), LLMCall, Token 汇总统计 + 成本估算（GPT-4 pricing）, 聚合时间线：events + llm_calls + tool_calls 混合排序, 单条 LLM 调用详情（含完整 prompt 和 response）, token_summary() (+76 more)
...
Cohesion: 0.04
Nodes (20): AssetService, Asset, AssetLink, Decision, DecisionAsset, StageRun, StageRunAsset, DecisionEffectsCoordinator (+12 more)
...
Cohesion: 0.05
Nodes (20): ABC, JSON Schema for a tool, ToolSchema, _api_request(), _get_default_repo(), _get_headers(), GitHubManagerTool, Manage a GitHub repository: files, branches, commits, releases, tags, issues, PR (+12 more)
...
- **Thin community `Community 47`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 48`** (1 nodes): `从 SOUL JSON 动态组装 system_prompt`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 49`** (1 nodes): `将 engine 事件转发到所有通用 /ws 连接`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `BaseTool` connect `Community 0` to `Community 8`, `Community 10`, `Community 13`, `Community 6`?**
  _High betweenness centrality (0.100) - this node is a cross-community bridge._
- **Why does `Project` connect `Community 2` to `Community 0`, `Community 1`, `Community 5`, `Community 11`, `Community 15`?**
  _High betweenness centrality (0.095) - this node is a cross-community bridge._
- **Why does `ListCollaboratorsTool` connect `Community 0` to `Community 1`?**
...
- **Are the 96 inferred relationships involving `Project` (e.g. with `TestPipelineCreation` and `TestPipelineStart`) actually correct?**
  _`Project` has 96 INFERRED edges - model-reasoned connections that need verification._
