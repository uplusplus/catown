...
### `Expose canonical workflow specs via Pipeline API`
...
### `Project artifact publication policy decisions`
...
- `ArtifactPublicationPolicyResult.to_payload()` 新增 canonical `policy_decision`
...
### `Share policy decision summary formatting`
...
- 新增 `format_policy_decision_summary(...)`
