...
async def _trigger_standalone_assistant_response(
    ...
    standalone_runtime_context = build_single_agent_session_runtime_context(
        db=db,
        task_run=task_run,
        chatroom_id=chatroom_id,
        client_turn_id=client_turn_id,
...
async def _stream_standalone_assistant_response(
    ...
    standalone_stream_runtime_context = build_single_agent_session_runtime_context(
        db=db,
        task_run=task_run,
        chatroom_id=chatroom_id,
        client_turn_id=client_turn_id,
...
async def trigger_agent_response(
    ...
    try:
        ...
        project_single_agent_runtime_context = build_single_agent_session_runtime_context(
            db=db,
            task_run=task_run,
            chatroom_id=chatroom_id,
            client_turn_id=client_turn_id,
...
async def send_message_stream(chatroom_id: int, message: MessageRequest, request: Request):
    ...
    async def raw_event_generator():
        ...
        try:
            ...
            project_single_agent_stream_runtime_context = build_single_agent_session_runtime_context(
                db=db,
                task_run=task_run,
                chatroom_id=chatroom_id,
                client_turn_id=message.client_turn_id,
