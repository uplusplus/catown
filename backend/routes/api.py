...
async def _stream_standalone_assistant_response(
    ...
    async for outcome in iter_managed_single_agent_stream_session_profile(
        build_managed_single_agent_stream_session_profile_from_runtime(
            ...
            db=db,
            task_run=task_run,
            session_agent_id=runtime.assistant_id,
            session_agent_name=runtime.assistant_name,
            session_agent_type=runtime.assistant_name,
            user_message=user_message,
            save_message=chatroom_manager.send_message,
            publish_message=publish_saved_chat_message,
            record_turn_completed=record_agent_turn_completed,
        ...
        try:
            ...
            async for outcome in iter_managed_single_agent_stream_session_profile(
                build_managed_single_agent_stream_session_profile_from_runtime(
                    ...
                    db=db,
                    task_run=task_run,
                    session_agent_id=target_agent.id,
                    session_agent_name=target_agent_label,
                    session_agent_type=_agent_type(target_agent),
                    user_message=message.content,
                    save_message=chatroom_manager.send_message,
                    publish_message=publish_saved_chat_message,
                    record_turn_completed=record_agent_turn_completed,
