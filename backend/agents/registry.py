...
def get_builtin_agent_configs() -> List[Union[AgentConfig, AgentConfigV2]]:
    ...
    return [
        ...
        create_agent_config_from_provider(
            ...
            provider_config=default_provider,
            tools=["web_search", "retrieve_memory", "read_file", "write_file", "analyze_image", "analyze_document"]
        ),
        create_agent_config_from_provider(
        ...
        create_agent_config_from_provider(
            ...
            provider_config=default_provider,
            tools=["web_search", "retrieve_memory", "read_file", "write_file", "list_files", "execute_code", "run_shell", "search_files", "analyze_image", "analyze_document", "browser", "screenshot", "screenshot_compare"]
        ),
        create_agent_config_from_provider(
            agent_type="tester",
            ...
            provider_config=default_provider,
            tools=["retrieve_memory", "read_file", "execute_code", "run_shell", "list_files", "search_files", "analyze_image", "analyze_document", "screenshot", "screenshot_compare"]
        ),
        create_agent_config_from_provider(
            agent_type="release",
