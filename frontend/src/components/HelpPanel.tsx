...
export function HelpPanel({ open, onClose }: Props) {
  ...
  return (
    <div className="help-overlay" role="dialog" aria-modal="true" aria-label="Cockpit homepage help">
      <section className="help-panel panel-shell">
        <div className="help-header">
          <div>
            <p className="eyebrow">Help</p>
            <h2>How to use the cockpit homepage</h2>
          </div>
        ...
        <div className="help-section">
          ...
          <ol className="help-list ordered">
            ...
            <li>Read the navigation surface and action focus before acting.</li>
            <li>Resolve any pending decision first.</li>
            <li>Use Continue Project to push the mission forward.</li>
            <li>Inspect route, assets, and activity after each change.</li>
          </ol>
        </div>
        ...
        <div className="help-grid">
          <div className="help-section">
            ...
            <ul className="help-list">
              <li>If the decision area shows pending items, open one and approve or reject it.</li>
              <li>Pending decisions can block Continue Project.</li>
              <li>Decision detail in the inspection rail gives the context you need.</li>
            </ul>
          </div>
          ...
          <div className="help-section">
            ...
            <ul className="help-list">
              ...
              <li>After success, the cockpit refreshes overview, stage runs, decisions, and assets.</li>
            </ul>
          </div>
        </div>
        ...
        <div className="help-section">
          ...
          <ul className="help-list">
            <li><strong>Selected Mission</strong> gives project status, focus, stage, and block reason.</li>
