...
>
> **当前默认主前端已不是这些旧壳。** 当前实现以 `React + Vite + TypeScript` 的 Mission Board 为主，代码位于 `frontend/src/`，`frontend/index.html` 仅作为 Vite shell。
>
> 后续前端开发、测试和交付，应优先以 project-first Mission Board 为准，相关决策见：
>
